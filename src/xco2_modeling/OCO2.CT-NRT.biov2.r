...
# input variables needed: ident, footprint matrix, path for storing biospheric contributions
# Written by Dien Wu, 02/10/2017

# Update for CT-NRTv2017, DW

ctnrt.biov2<-function(ident, foot=foot.bio, ct.version, storeTF=FALSE, ncdfpath){

  library(ncdf4)
  sourcepath<-"/uufs/chpc.utah.edu/common/home/lin-group1/wde/STILT_modeling/stiltR/"
  source(paste(sourcepath,"sourceall.r",sep=""))  # source all
