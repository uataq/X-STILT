...
#### ERROR line ####
# Error occured when running trajec with wind errors
# Quick fix: suppress the error, by DW
#unix.shell(paste("source ",rundir,"runhymodelc.bat",sep=""),shell="/bin/csh")
try(unix.shell(paste("source ",rundir,"runhymodelc.bat",sep=""),shell="/bin/csh"),silent=TRUE)   #output in 'PARTICLE.DAT' in same directory, # this is where generating trajs
