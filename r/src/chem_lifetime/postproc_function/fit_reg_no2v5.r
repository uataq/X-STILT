...
fit_reg_tno2v5 = function(pr_edgar = NULL, pr_epa = NULL, pr_odiac = NULL) {
    ...
    if ( !is.null(pr_odiac) ) {
        lm9 = lmodel2(sim_tno2_nochem ~ obs_tno2, pr_odiac)$regression.results 
        lm10 = lmodel2(sim_tno2_mix ~ obs_tno2, pr_odiac)$regression.results 
        lm11 = lmodel2(sim_tno2_nomix ~ obs_tno2, pr_odiac)$regression.results 
