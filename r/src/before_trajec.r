...
before_trajec <- function(output, r_zagl = 5, run_trajec, varsiwant, conage, 
                          cpack, dxf, dyf, dzf, emisshrs, frhmax, frhs, frme, 
                          frmr, frts, frvs, hnf_plume, hscale, ichem, iconvect, 
                          initd, isot, kbls, kblt, kdef, khmax, kmix0, kmixd, 
                          kmsl, kpuff, krnd, kspl, kzmix, maxdim, maxpar, 
                          met_file_format, met_loc, mgmin, ncycl, ndump, ninit, 
                          n_hours, outdt, outfrac, p10f, qcycle, random, splitf,
                          tkerd, tkern, rm_dat = T, rundir, timeout, tlfrac, 
                          tratio, tvmix, veght, vscale, w_option, zicontroltf, 
                          z_top) {
