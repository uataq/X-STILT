...
grab.tropomi.no2 <- function(tropomi.path = NULL, timestr = NULL, lon.lat, 
    ...
    dimnames(tropo_indx) <- dimnames(tropo_xno2) <- 
    dimnames(tropo_xno2_uncert) <- list(indx_across_track, indx_along_track)
    ...
    var_name <- list(c('center_lat', 'center_lon', 'time_utc', 'qa', 'hsfc', 
                       'psfc', 'sfc_class', 'tropo_k', 'tropo_xno2', 
                       'tropo_xno2_uncert'))
